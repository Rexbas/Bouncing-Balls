...
public class BouncingBalls {
	...
	public static SoundEvent sound_bounce;
	...
	public static Item dynamiteBouncingBall = new BouncingBall(BallType.DYNAMITE, 18).setUnlocalizedName("DynamiteBouncingBall");
	public static Item slimeBouncingBall = new BouncingBall(BallType.SLIME, 19).setUnlocalizedName("SlimeBouncingBall");
	public static Item clayBouncingBall = new BouncingBall(BallType.CLAY , 20).setUnlocalizedName("ClayBouncingBall");
	public static Item redstoneBouncingBall = new BouncingBall(BallType.REDSTONE, 21).setUnlocalizedName("RedstoneBouncingBall");
	public static Item glowstoneBouncingBall = new BouncingBall(BallType.GLOWSTONE, 22).setUnlocalizedName("GlowstoneBouncingBall");
	public static Item goldenBouncingBall = new BouncingBall(BallType.GOLD, 23).setUnlocalizedName("GoldenBouncingBall");
	public static Item ironBouncingBall = new BouncingBall(BallType.IRON, 24).setUnlocalizedName("IronBouncingBall");
	public static Item diamondBouncingBall = new BouncingBall(BallType.DIAMOND, 25).setUnlocalizedName("DiamondBouncingBall");
	public static Item obsidianBouncingBall = new BouncingBall(BallType.OBSIDIAN, 26).setUnlocalizedName("ObsidianBouncingBall");
	public static Item emeraldBouncingBall = new BouncingBall(BallType.EMERALD, 27).setUnlocalizedName("EmeraldBouncingBall");
	public static Item netherStarBouncingBall = new BouncingBall(BallType.NETHER_STAR, 28).setUnlocalizedName("NetherStarBouncingBall");
    ...
    public void init(FMLInitializationEvent event) {
    	sound_bounce = SoundEventRegistry.registerSoundEvent("bouncingball.bounce");
    }
