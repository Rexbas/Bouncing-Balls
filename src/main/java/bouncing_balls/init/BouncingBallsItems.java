...
public class BouncingBallsItems {
	...
	public static final RegistryObject<Item> TEST = ITEMS.register("test", () -> new BouncingBall(new Item.Properties().tab(BouncingBalls.ITEMGROUP), new BouncingBall.Properties()));
	public static final RegistryObject<Item> TEST2 = ITEMS.register("test2", () -> new MultiBouncingBall(new Item.Properties().tab(BouncingBalls.ITEMGROUP), new BouncingBall.Properties(100, Items.DIAMOND, 0.5f, 0.65f, 12f, 0.3f), 5, Items.GUNPOWDER));
}