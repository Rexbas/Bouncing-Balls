...
public class SnowBouncingBall extends BouncingBall {
	...
	public SnowBouncingBall() {
		super(new Item.Properties().tab(BouncingBalls.ITEMGROUP), new BouncingBall.Properties(0.65f, 0.65f, 14f, 0.3f, false, 3, Items.SNOWBALL).addFluid(FluidTags.WATER));
	}
