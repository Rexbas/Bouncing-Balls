...
public class BouncingBallsItems {
	...
	public static final RegistryObject<Item> LIME = ITEMS.register("lime", () -> new BouncingBall(new Item.Properties().tab(BouncingBalls.ITEMGROUP), new BouncingBall.Properties()));
